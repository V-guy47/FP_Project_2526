...
1. Gere a chave SSH
    -  Siga os passos indicados no [exemplo de gerar chave ssh](https://gitlab.rnl.tecnico.ulisboa.pt/iaed/iaed26/iaed26/-/tree/master/docs/generate_key.pdf)

2. Introduza a chave pública SSH no GitLab
    -  Siga os passos indicados no [exemplo de definir chave ssh no GitLab da RNL](https://gitlab.rnl.tecnico.ulisboa.pt/iaed/iaed26/iaed26/-/tree/master/docs/define_key.pdf)

3. Clone o repositório dos laboratórios
    -  Siga os passos indicados no [exemplo de clonar o repositório do GitLab](https://gitlab.rnl.tecnico.ulisboa.pt/iaed/iaed26/iaed26/-/tree/master/docs/clone_repo.pdf)

4. Para quem precisar instalar o WSL em Windows, podem [seguir as seguintes instruções](https://gitlab.rnl.tecnico.ulisboa.pt/iaed/iaed26/iaed26/-/tree/master/docs/vscode_wsl.pdf)
...
6. Actualize o repositório no GitLab e verifique o resultado da avaliação
    -  Siga as instruções indicadas no [exemplo de actualizar o repositório](https://gitlab.rnl.tecnico.ulisboa.pt/iaed/iaed26/iaed26/-/tree/master/docs/update_repo.pdf)

7. Introduza vários tipos de erros e verifique o resultado da avaliação
